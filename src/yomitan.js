...
/**
 * @import * as core from './types/yomitan/core'
...
class ExtensionError extends Error {
     ...
     * @returns {core.SerializedError} A simple object which can be serialized by `JSON.stringify()`.
     */
    static serialize(error) {
        try {
            if (typeof error === 'object' && error !== null) {
                const {name, message, stack} = /** @type {core.SerializableObject} */ (error);
                /** @type {core.SerializedError1} */
                const result = {
        ...
        return /** @type {core.SerializedError2} */ ({
            value: error,
            hasValue: true,
        });
    }
     ...
     * @param {core.SerializedError} serializedError A simple object which was initially generated by the `serialize` function.
...
export class AnkiConnect {
    ...
    /**
     * @param {anki.Note} note
     * @returns {Promise<?anki.NoteId>}
     */
    async addNote(note) {
        if (!this._enabled) { return null; }
        await this._checkVersion();
    ...
    /**
     * @param {anki.NoteId[]} noteIds
     * @returns {Promise<(?anki.NoteInfo)[]>}
     */
     ...
     * @param {anki.NoteId} noteId The ID of the note.
     ...
     * @returns {Promise<anki.NoteId[]>} An array of note IDs.
     ...
     * @returns {Promise<anki.ApiReflectResult>} Information about the APIs.
     */
    async apiReflect(scopes, actions = null) {
        ...
        const {scopes: resultScopes, actions: resultActions} = /** @type {core.SerializableObject} */ (result);
    ...
    isErrorUnsupportedAction(error) {
        if (error instanceof ExtensionError) {
            const {data} = error;
            if (typeof data === 'object' && data !== null && /** @type {core.SerializableObject} */ (data).apiError === 'unsupported action') {
                return true;
            }
        }
        return false;
    ...
    /**
     * @param {string} action
     * @param {core.SerializableObject} params
     * @returns {Promise<unknown>}
     */
    async _invoke(action, params) {
        /** @type {anki.MessageBody} */
        ...
        if (typeof result === 'object' && result !== null && !Array.isArray(result)) {
            const apiError = /** @type {core.SerializableObject} */ (result).error;
    ...
    /**
     * @param {{action: string, params: core.SerializableObject}[]} actions
     * @returns {Promise<unknown[]>}
     */
    ...
    _normalizeNoteInfoArray(result) {
        ...
        for (let i = 0, ii = result.length; i < ii; ++i) {
            ...
            /** @type {{[key: string]: anki.NoteFieldInfo}} */
            const fields2 = {};
